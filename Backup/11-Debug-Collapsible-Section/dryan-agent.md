...
If **any** debug flag is `on`, append a collapsible debug log section after the footer:

```markdown
<details>
<summary>Debug Log</summary>

{all [DEBUG:*] lines collected during this run, one per line}

</details>
```

> Debug lines are **only** written to this section — never inline with the content above.

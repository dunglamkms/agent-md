...
Merged response combining research findings, draft, and prior context.
...
- If `debug_dispatch = on`, log subagent dispatch timestamps
- If `debug_merge = on`, log merge inputs and output
